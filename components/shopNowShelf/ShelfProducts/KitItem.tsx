...
const Input = ({ item, dataDispatch, product }: InputProps) => {
  const { state, dispatch } = useShelfProductsContext();
...
export default function KitItem({ productId, dataDispatch }: Props) {
  ...
  return (
    <div
      class="lg:flex items-start border-b border-[#bea669] pb-5 mb-5 w-full gap-3 lg:h-auto h-[470px]"
    ...
    >
      ...
      <div>
        ...
        <div>
          ...
          <ul class="flex lg:gap-2 gap-1 items-center justify-start flex-wrap">
