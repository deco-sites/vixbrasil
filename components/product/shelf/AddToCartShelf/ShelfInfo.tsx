  ...
  return (
    <div class="flex items-center justify-center w-full">
      <div class="relative">
        ...
        <div
          class="hidden lg:block h-auto border border-[#e8e8e8] mx-auto cursor-pointer w-[120px] mb-[10px] absolute top-2 bg-white opacity-0 duration-200 group-hover/image-shelf:opacity-100 left-[-25px]"
          onMouseLeave={() => {
            setDropdown("h-[0px]");
          }}
        >
