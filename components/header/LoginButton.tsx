  ...
  return (
    <>
      <button
        ...
        class={`flex items-center gap-3 pl-4 pr-3 py-1 sm:bg-[#E9DFC980] group-hover/header:text-black font-source-sans text-xs tracking-[0.98px] text-black relative rounded-btn sm:border sm:border-[#bea669]`}
        onClick={() => {
          setLoginOpen(true);
        }}
      >
