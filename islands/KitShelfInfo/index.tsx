          ...
          >
            ...
            >
              {productTop?.items?.map((item) => {
                ...
                return (
                  <li
                    class={`block w-[120px] bg-white  duration-200 p-2 font-source-sans text-sm tracking-[0.07em] ${
                      !avaibility && "hover:bg-[#bea669] cursor-pointer"
                    }`}
                    onClick={() => {
                      dispatch({
                        type: "SET_KIT_1",
                  ...
                  >
                    <span class={`${avaibility && "opacity-40"}`}>
                      {item.Tamanho[0]}
                    </span>
                  </li>
                );
